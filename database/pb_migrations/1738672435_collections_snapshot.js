...
migrate((app) => {
  const snapshot = [
    ...
    },
    {
      ...
      "deleteRule": "@request.auth.id != \"\" && @request.auth.role.permission > 30",
      "emailChangeToken": {
        "duration": 1800
      },
      "fields": [
      ...
      "system": false,
      "type": "auth",
      "updateRule": "@request.auth.id != \"\" && @request.auth.role != \"user\"",
      "verificationTemplate": {
        "body": "<p>Hello,</p>\n<p>Thank you for joining us at {APP_NAME}.</p>\n<p>Click on the button below to verify your email address.</p>\n<p>\n  <a class=\"btn\" href=\"{APP_URL}/_/#/auth/confirm-verification/{TOKEN}\" target=\"_blank\" rel=\"noopener\">Verify</a>\n</p>\n<p>\n  Thanks,<br/>\n  {APP_NAME} team\n</p>",
        "subject": "Verify your {APP_NAME} email"
      },
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          "hidden": false,
          "id": "bool3338003327",
          "name": "enable_google_cloud_backup",
          "presentable": false,
          "required": false,
          "system": false,
          "type": "bool"
    ...
    },
    {
      ...
      "fields": [
        ...
        {
          "cascadeDelete": false,
          "collectionId": "pbc_2344834334",
          "hidden": false,
          "id": "relation3696955672",
          "maxSelect": 1,
          "minSelect": 0,
          "name": "app_language",
          "presentable": false,
      ...
      "system": false,
      "type": "base",
      "updateRule": "@request.auth.id = user_id.user_settings_via_user_id.user_id",
      "viewRule": "@request.auth.id = user_id.user_settings_via_user_id.user_id"
    },
    {
      "createRule": "@request.auth.id != \"\" && @request.auth.role = \"admin\"",
      "deleteRule": "@request.auth.id != \"\" && @request.auth.role = \"admin\"",
